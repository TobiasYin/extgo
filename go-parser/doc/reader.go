...
func (mset methodSet) set(f *ast.FuncDecl, preserveAST bool) {
	...
	if g := mset[name]; g != nil && g.Doc != "" {
		...
		// caller is using github.com/TobiasYin/extgo/go-parser/build.ScanDir to determine the list of
		...
		case *ast.GenDecl:
			...
			case token.TYPE:
				...
				if len(d.Specs) == 1 && !d.Lparen.IsValid() {
					...
					// github.com/TobiasYin/extgo/go-parser/doc type declarations always appear w/o
					// parentheses)
