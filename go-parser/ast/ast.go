...
type (
	...
	// Tobias
	QuesExpr struct {
		Ques token.Pos // position of "?"
		X    Expr      // operand, must call expression
	}
...
func (x *QuesExpr) Pos() token.Pos       { return x.X.Pos() }
...
func (x *QuesExpr) End() token.Pos       { return x.Ques + 1 }
...
// github.com/TobiasYin/extgo/go-parser/format and github.com/TobiasYin/extgo/go-parser/printer), special care must be taken to update comments
