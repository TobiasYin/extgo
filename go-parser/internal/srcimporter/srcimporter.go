...
package srcimporter // import "github.com/TobiasYin/extgo/go-parser/internal/srcimporter"

import (
	"fmt"
	"github.com/TobiasYin/extgo/go-parser/ast"
	"github.com/TobiasYin/extgo/go-parser/build"
	"github.com/TobiasYin/extgo/go-parser/parser"
	"github.com/TobiasYin/extgo/go-parser/token"
	"github.com/TobiasYin/extgo/go-parser/types"
...
func New(ctxt *build.Context, fset *token.FileSet, packages map[string]*types.Package) *Importer {
	return &Importer{
		ctxt:     ctxt,
		fset:     fset,
		sizes:    types.SizesFor(ctxt.Compiler, ctxt.GOARCH), // uses github.com/TobiasYin/extgo/go-parser/types default if GOARCH not found
		packages: packages,
	}
}
...
func (p *Importer) ImportFrom(path, srcDir string, mode types.ImportMode) (*types.Package, error) {
	...
	if firstHardErr != nil {
		// this can only happen if we have a bug in github.com/TobiasYin/extgo/go-parser/types
...
//go:linkname setUsesCgo github.com/TobiasYin/extgo/go-parser/types.srcimporter_setUsesCgo
