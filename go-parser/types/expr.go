...
import (
	...
	"github.com/TobiasYin/extgo/go-parser/internal/typeparams"
...
func (check *Checker) overflow(x *operand, op token.Token, opPos token.Pos) {
	...
	if x.val.Kind() == constant.Unknown {
		...
		//           moment we don't have the (github.com/TobiasYin/extgo/go-parser/constant) API for that.
		//           See also TODO in github.com/TobiasYin/extgo/go-parser/constant/value.go.
...
func (check *Checker) exprInternal(x *operand, e ast.Expr, hint Type) exprKind {
	...
	case *ast.BasicLit:
		...
		case token.INT, token.FLOAT, token.IMAG:
			...
			// represented accurately in the github.com/TobiasYin/extgo/go-parser/constant package.
		...
		if x.mode == invalid {
			...
			// TODO(gri) setConst (and in turn the github.com/TobiasYin/extgo/go-parser/constant package)
