...
func (p *printer) internalError(msg ...interface{}) {
	if debug {
		...
		fmt.Println(msg...)
		panic("github.com/TobiasYin/extgo/go-parser/printer")
	}
}
...
func (p *printer) print(args ...interface{}) {
	for _, arg := range args {
		...
		default:
			...
			panic("github.com/TobiasYin/extgo/go-parser/printer type")
		}
		// data != ""
...
unsupported:
	return fmt.Errorf("github.com/TobiasYin/extgo/go-parser/printer: unsupported node type %T", node)
}
...
// the evolving needs of github.com/TobiasYin/extgo/go-parser/format and cmd/gofmt without breaking
...
const (
	...
	//
	// This value is known in and used by github.com/TobiasYin/extgo/go-parser/format and cmd/gofmt.
...
// use format.Node (package github.com/TobiasYin/extgo/go-parser/format) for output that matches gofmt.
//
